...
const processData = async () => {
  ...
  // await SaveYellowBetLeaguesWithFixturesService.syncLeaguesAndFixtures();
  //Betclic
  ...
  // await SaveBetMomoLeaguesWithFixturesService.syncLeaguesAndFixtures();
  //ONEBET
  ...
  // await SaveSuperGoalLeaguesWithFixturesService.syncLeaguesAndFixtures();
};
