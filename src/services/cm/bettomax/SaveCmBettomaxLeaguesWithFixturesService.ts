...
class SaveCmBettomaxLeaguesWithFixturesService {
    ...
    async syncLeaguesAndFixtures() {
        ...
        const filePath = `./files/cm/cm_bettomax_countries_leagues_fixtures_${dateStr}.json`;
...
export default new SaveCmBettomaxLeaguesWithFixturesService();