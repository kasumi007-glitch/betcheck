...
class FetchBWinnersLeaguesService {
    ...
    async syncLeagues() {
        await this.init();
        console.log("🚀 Fetching BWinners leagues...");
        ...
        console.log("✅ BWinners leagues synced successfully!");
    }

    private async processLeague(dbCountry: any, tournament: any, sourceCategoryId: string) {
...
export default FetchBWinnersLeaguesService;