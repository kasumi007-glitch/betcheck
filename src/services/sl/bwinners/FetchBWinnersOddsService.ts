...
class FetchBWinnersOddsService {
    ...
    // Mapping from BWinners market types to our groups
    ...
    // Mapping from BWinners outcome names to our market names
    ...
    async syncOdds() {
        await this.init();
        console.log("🚀 Fetching BWinners odds...");
        ...
        console.log("✅ BWinners odds synced successfully!");
    }
    ...
    private async processOdd(
        ...
        const mappedName = outcomeMap[oddName.toLowerCase()];
        if (!mappedName) {
...
export default FetchBWinnersOddsService;