...
class FetchCdBetwinnerLeagueService {
    private readonly apiUrl = "https://betwinner1.com/service-api/LineFeed/GetChampsZip?sport=1&lng=en&country=213&partner=152&virtualSports=true&groupChamps=true";
    // private readonly apiUrl = "https://betwinner.ng/service-api/LineFeed/GetSportsShortZip?sports=1&lng=en&country=213&partner=152&virtualSports=true&gr=526&groupChamps=true";
    ...
    async syncLeagues() {
        ...
        for (const leagueData of response?.Value) {
...
export default FetchCdBetwinnerLeagueService;
