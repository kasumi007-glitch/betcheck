...
class FetchCdMojabetOddsService {
    private readonly oddsApiUrlTemplate = "https://mojabet.cd/api/Football/events/{eventId}/popular/odds";
    ...
    private readonly groupMapping: Record<string, string> = {
        "Fin du match (temps réglementaire)": "1X2",
        "Total": "Over / Under",
        "Les deux équipes marquent": "Both Teams to Score"
    };
    ...
    async syncOdds() {
        await this.init();
        console.log("🚀 Fetching CD Mojabet odds...");
        ...
        console.log("✅ CD Mojabet odds synced successfully!");
    }
...
export default FetchCdMojabetOddsService;