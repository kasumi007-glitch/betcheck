...
class SaveCdMojabetLeaguesWithFixturesService {
    ...
    async syncLeaguesAndFixtures() {
        ...
        const filePath = `./files/cd/cd_mojabet_countries_leagues_fixtures_${dateStr}.json`;

        // Create directory if it doesn't exist
        const dirPath = './files/cd';
...
export default new SaveCdMojabetLeaguesWithFixturesService();