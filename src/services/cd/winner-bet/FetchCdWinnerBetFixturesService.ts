...
class FetchCdWinnerBetFixturesService {
    ...
    async syncFixtures() {
        await this.init();
        console.log("🚀 Fetching CD Winner bet fixtures...");
        ...
        for (const league of sourceLeagues) {
            ...
            const url = `${this.fixturesApiUrl}&leagueIds=${league.leagueIds}`;
        ...
        console.log("✅ CD Winner bet fixtures synced successfully!");
    }
...
export default FetchCdWinnerBetFixturesService;