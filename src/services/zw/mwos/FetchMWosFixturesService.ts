...
class FetchMWosFixturesService {
    private readonly fixturesApiUrl = "https://betting.co.zw/services/evapi/event/GetEvents?betTypeIds=-1&take=100&statusId=0&eventTypeId=0";
    ...
    async syncFixtures() {
        await this.init();
        console.log("🚀 Fetching MWos fixtures...");
        ...
        console.log("✅ MWos fixtures synced successfully!");
    }
...
export default FetchMWosFixturesService;