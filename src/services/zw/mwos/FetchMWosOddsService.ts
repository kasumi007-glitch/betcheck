...
class FetchMWosOddsService {
    private readonly oddsApiUrl = "https://betting.co.zw/services/evapi/event/GetEvents?eventIds=";
    private readonly sourceName = "ZW_MWOS";
    private sourceId!: number;
    private dbGroups: Group[] = [];
    private dbMarkets: Market[] = [];

    // Mapping from MWos market types to our groups
    ...
    // Mapping from MWos outcome names to our market names
    ...
    async syncOdds() {
        await this.init();
        console.log("🚀 Fetching MWos odds...");
        ...
        console.log("✅ MWos odds synced successfully!");
    }
...
export default FetchMWosOddsService;