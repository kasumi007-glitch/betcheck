...
class SaveBet223LeaguesWithFixturesService {
    private readonly url = "https://www.bet2africa.ml/en/sports/pre-match/event-view/Soccer";
    ...
    async syncLeaguesAndFixtures() {
        ...
        const filePath = `./files/bet223_countries_leagues_fixtures_${dateStr}.json`;
...
export default new SaveBet223LeaguesWithFixturesService();
